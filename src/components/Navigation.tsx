  ...
  return (
    <nav className="bg-white">
      ...
      <div className="flex px-6 py-2 justify-between items-center">
        ...
        <Link
          href="/"
          className="flex justify-around w-full h-full text-2xl items-center"
        >
          <Image
            alt="logo"
            height={120}
          ...
          <span className="text-[#db0232] hidden md:block">
            Mfg. Manpower allocation control
          </span>
        </Link>
        {/* login in the right corner */}
